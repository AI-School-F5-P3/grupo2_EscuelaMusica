...
class PriceInstrument(db.Model):
    ...
    pack = db.Column(Enum('pack1', 'pack2', 'pack3'))
...
class Discount(db.Model):
    ...
    group_discount = db.Column(Enum('pack1', 'pack2', 'pack3'))
...
class PriceInstrumentEnrollment(db.Model):
    ...
    price_instrument_pack = db.Column(Enum('pack1', 'pack2', 'pack3'), primary_key=True)
